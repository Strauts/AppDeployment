...
public:
    ...
    void setupUi(QDialog *settingsDialog)
    {
        ...
        settingsDialog->setStyleSheet(QString::fromUtf8("background-color: rgb(146, 232, 255);"));
        ...
        groupBoxSettings->setGeometry(QRect(-1, 99, 471, 571));
        groupBoxSettings->setStyleSheet(QString::fromUtf8(""));
